    ...
    <div class="row m-2">
        ...
        <div class="col-sm-12 col-xl-6">
            <div class="bg-light rounded h-100 p-4">
                ...
                <asp:GridView ID="category_grid" CssClass="category_grid" runat="server" AllowPaging="True" AutoGenerateColumns="False" HeaderStyle-CssClass="category_header" RowStyle-CssClass="category_row" DataKeyNames="id">
                    <Columns>
